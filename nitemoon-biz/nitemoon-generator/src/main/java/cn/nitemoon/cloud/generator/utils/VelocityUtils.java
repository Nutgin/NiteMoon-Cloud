package cn.nitemoon.cloud.generator.utils;
...
public class VelocityUtils {
	...
	public static String getFileName(String template, GenTable genTable) {
		...
		if (template.contains("sub-entity.java.vm")
			...
			fileName = StrUtil.format("tsx/api/services/{}/{}Service.ts", moduleName, businessName);
		}
		else if (template.contains("index.tsx.vm")) {
			fileName = StrUtil.format("tsx/pages/{}/{}/index.tsx", moduleName, businessName);
		}
		return fileName;
	}
