...
public class CacheServiceImpl implements CacheService {
    ...
    public CacheInfoVo getCacheInfo() {
        ...
        vo.setMaxmemory(maxMemory.equals("0") ? "∞" : formatBytes(Long.parseLong(maxMemory)));

        // 持久化信息
        vo.setAofEnabled("1".equals(info.getProperty("aof_enabled")) ? "1" : "0");
        vo.setRdbLastSaveStatus("ok".equals(info.getProperty("rdb_last_bgsave_status")) ? "1" : "0");
