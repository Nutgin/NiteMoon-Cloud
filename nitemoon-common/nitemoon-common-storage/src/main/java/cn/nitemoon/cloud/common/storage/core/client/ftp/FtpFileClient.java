package cn.nitemoon.cloud.common.storage.core.client.ftp;
...
public class FtpFileClient extends AbstractFileClient<FtpFileClientConfig> {
    ...
    public FtpFileClient(Long id, FtpFileClientConfig config, Boolean cloudEnable) {
    ...
    public InputStream getContentAsStream(String path) {
        return new ByteArrayInputStream(getContent(path));
    }
