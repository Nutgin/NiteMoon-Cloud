...
public class S3FileClientConfig implements FileClientConfig {
    ...
    /**
     * 节点地址
     * 1. MinIO：https://www.unicom.cn/Spring-Boot/MinIO 。例如说，http://127.0.0.1:9000
    ...
    /**
     * 访问 Key
     * 1. MinIO：https://www.unicom.cn/Spring-Boot/MinIO
    ...
    /**
     * 是否为私有 Bucket
     * true: 私有bucket，需要通过后端代理访问
     * false: 公开bucket，可以直接访问
     */
    private Boolean privateBucket = false;

    /**
     * 后端服务域名
     * 用于私有bucket的代理访问，格式如：https://api.nitemoon.cn
     * 如果为空，则使用domain字段
     */
