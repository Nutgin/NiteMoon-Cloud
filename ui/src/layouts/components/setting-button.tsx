...
export default function SettingButton() {
	...
	const handleKeyDown = useCallback((event: KeyboardEvent) => {
		//如果按下的是Escape键，并且全屏可用，并且全屏状态为true，则设置全屏状态为false
							...
							<div className="flex flex-wrap gap-1">
								{Object.entries(presetsColors).map(([preset, color]) => (
									<button
										...
										type="button"
										className={cn(
											"relative flex h-13 w-5 cursor-pointer items-center justify-center rounded transition-all duration-300 ease-in-out p-1 border-0 bg-transparent",
