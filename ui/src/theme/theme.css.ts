...
// Special handling for dark mode + black theme: Badge success variant should have white background and black text
globalStyle(`:root[${HtmlDataAttribute.ThemeMode}=dark][${HtmlDataAttribute.ColorPalette}=black] [data-slot="badge"][data-variant="success"]`, {
