    ...
    variants: {
      variant: {
        ...
        destructive:
				...
				success: "border-transparent bg-[var(--colors-palette-primary-default)] text-white [a&]:hover:bg-[var(--colors-palette-primary-dark)] focus-visible:ring-[var(--colors-palette-primary-default)]/20 dark:focus-visible:ring-[var(--colors-palette-primary-default)]/40",
